...
signal-port-description-trigger-receiver = Активирует механизм на устройстве.
...
signal-port-description-logic-random-input = Принимает любой сигнал для генерации случайного выхода.
