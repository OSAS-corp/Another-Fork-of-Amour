...
signal-port-description-trigger-sender = Этот порт срабатывает каждый раз, когда устройство активируется.
signal-port-name-timer-trigger = Таймер
signal-port-description-timer-trigger = Этот порт срабатывает каждый раз, когда таймер заканчивается.
