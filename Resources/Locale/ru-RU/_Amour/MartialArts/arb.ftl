...
arb-success-learned = Вы освоили приёмы армейского рукопашного боя!

martial-arts-combo-ArbArmLock = Залом руки
martial-arts-combo-ArbSweep = Подсечка
martial-arts-combo-ArbChoke = Удушающий захват
